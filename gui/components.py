...
class ImagePanel(ctk.CTkFrame):
    def __init__(self, master, label_text, size=(280, 280), **kwargs):
        ...
        self.size = size
        self.header = ctk.CTkLabel(self, text=label_text, font=("Segoe UI", 12, "bold"), fg_color="#333333", corner_radius=5)
    ...
    def update_image(self, cv_img):
        ...
        img_ui = np.clip(cv_img, 0, 255).astype(np.uint8)
        pil_img = Image.fromarray(img_ui)
        ...
        self.display_label._image_ref = ctk_img